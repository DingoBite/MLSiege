...
namespace Assets.Siege.Model.BlockSpace.Repositories
{
    public class FrameBlockRepository: IRepository<FrameBlock>
    {
        ...
        public IEnumerable<FrameBlock> GetCustomers()
        {
            return _frameBlocks.Values;
        }

        public bool TryGetCustomerById(int id, out FrameBlock customer)
        {
            return _frameBlocks.TryGetValue(id, out customer);
        }
